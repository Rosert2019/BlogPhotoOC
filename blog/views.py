...
@login_required
def mes_postes(request): 
    photos = models.Photo.objects.all() 
    return render(request, 'blog/mes_postes.html', context={'photos': photos})  



#modifier ou supprmier un billet blog
@login_required
...
#Pour permettre à un utilisateur de suivre un autre utilisateur ou d'être suivi
@login_required
